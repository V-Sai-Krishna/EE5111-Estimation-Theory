...
%% PLOTS 
plot([1:1:iterations-1],est_q1(1:iterations-1,1));
xlabel('Number of iterations');
ylabel('Estimate at kth iteration');
title('Learning curve of estimate of p');
%%
plot([1:1:iterations-1],est_q1(1:iterations-1,2));
xlabel('Number of iterations');
ylabel('Estimate at kth iteration');
...
%% PLOTS 
plot([1:1:iterations-1],est_q2(1:iterations-1,1));
xlabel('Number of iterations');
ylabel('Estimate at kth iteration');
title('Learning curve of estimate of pi');
%%
plot([1:1:iterations-1],est_q2(1:iterations-1,2));
xlabel('Number of iterations');
ylabel('Estimate at kth iteration');
title('Learning curve of estimate of p');
%%
plot([1:1:iterations-1],est_q2(1:iterations-1,3));
xlabel('Number of iterations');
ylabel('Estimate at kth iteration');
title('Learning curve of estimate of q');
...
%% PLOTS 
plot([1:1:iterations-1],est_q3(1:iterations-1,1));
xlabel('Number of iterations');
ylabel('Estimate at kth iteration');
title('Learning curve of estimate of pi');
%%
plot([1:1:iterations-1],est_q3(1:iterations-1,2));
xlabel('Number of iterations');
ylabel('Estimate at kth iteration');
title('Learning curve of estimate of p');
%%
plot([1:1:iterations-1],est_q3(1:iterations-1,3));
xlabel('Number of iterations');
ylabel('Estimate at kth iteration');
title('Learning curve of estimate of q');
